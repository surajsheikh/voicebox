...
def has_tts_runaway(
    ...
    max_internal_silence_ms: int = 10000,
) -> bool:
    ...
    Threshold at 10000ms: ICL-mode voice cloning produces variable silence
    gaps at the reference-to-content transition (2-8s depending on profile).
    Real runaways produce 15-30+ second gaps. The no_repeat_ngram_size=6
    constraint handles actual repeats at the model level.
    """
